#!/usr/bin/env python3
"""
build-docx.py — Pressure Washing Business Starter Kit .docx generator (stdlib only).
...
DOCS = [
    ("06-residential-service-agreement.md", "route-ready-pw-residential-service-agreement.docx",
     "Route Ready — Residential Pressure Washing Service Agreement"),
    ("07-commercial-contract-bid.md", "route-ready-pw-commercial-contract-bid.docx",
     "Route Ready — Commercial Pressure Washing Contract & Bid"),
    ("08-client-intake-form.md", "route-ready-pw-client-intake-form.docx",
     "Route Ready — Client Intake Forms"),
    ("09-quote-estimate-template.md", "route-ready-pw-quote-estimate.docx",
     "Route Ready — Quote / Estimate Template"),
    ("10-invoice-template.md", "route-ready-pw-invoice.docx",
     "Route Ready — Invoice Template"),
    ("11-client-welcome-packet.md", "route-ready-pw-welcome-packet.docx",
     "Route Ready — Client Welcome Packet"),
    ("12-policies-and-letters.md", "route-ready-pw-policies-and-letters.docx",
     "Route Ready — Policies & Letters"),
    ("13-liability-waiver.md", "route-ready-pw-liability-waiver.docx",
     "Route Ready — Liability Waiver & Property Condition Acknowledgment"),
    ("14-job-checklists.md", "route-ready-pw-job-checklists.docx",
     "Route Ready — Pressure Washing Job Checklists"),
    ("15-startup-checklist.md", "route-ready-pw-startup-checklist.docx",
