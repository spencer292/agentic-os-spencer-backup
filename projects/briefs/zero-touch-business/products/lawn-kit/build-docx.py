#!/usr/bin/env python3
"""
build-docx.py — Lawn Care Business Starter Kit .docx generator (stdlib only).
...
DOCS = [
    ("06-residential-service-agreement.md", "route-ready-lawn-residential-service-agreement.docx",
     "Route Ready — Residential Lawn Care Service Agreement"),
    ("07-commercial-landscaping-contract.md", "route-ready-lawn-commercial-landscaping-contract.docx",
     "Route Ready — Commercial Landscape Maintenance Contract"),
    ("08-client-intake-form.md", "route-ready-lawn-client-intake-form.docx",
     "Route Ready — Client Intake Forms"),
    ("09-quote-estimate-template.md", "route-ready-lawn-quote-estimate.docx",
     "Route Ready — Quote / Estimate Template"),
    ("10-invoice-template.md", "route-ready-lawn-invoice.docx",
     "Route Ready — Invoice Template"),
    ("11-client-welcome-packet.md", "route-ready-lawn-welcome-packet.docx",
     "Route Ready — Client Welcome Packet"),
    ("12-policies-and-letters.md", "route-ready-lawn-policies-and-letters.docx",
     "Route Ready — Policies & Letters"),
    ("13-property-waiver.md", "route-ready-lawn-property-waiver.docx",
     "Route Ready — Property Condition Acknowledgment & Damage Waiver"),
    ("14-seasonal-checklists.md", "route-ready-lawn-seasonal-checklists.docx",
     "Route Ready — Seasonal Service Schedule & Checklists"),
    ("15-startup-checklist.md", "route-ready-lawn-startup-checklist.docx",
