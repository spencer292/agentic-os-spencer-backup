...
fs.writeFileSync('_wed_plan_before.json',JSON.stringify(snap,null,2));
console.log('snapshotted current Tuesday plan:',Object.keys(snap).length,'stops -> _wed_plan_before.json');
