...
description: >
  Build a brand's strategic foundation — the questions-first layer a brand strategist
  runs BEFORE any colour, type or logo work. Conducts a discovery interview, then
  synthesises a complete strategy: brand archetype (12 Jungian + Aaker Big-Five read),
  Golden Circle (Why/How/What), Brand Key / Brand Pyramid → brand essence,
  mission/vision/values/promise, the Geoffrey Moore positioning statement (the strategic
  spine), and a written moodboard direction to hand to visual design. Triggers on:
  "brand strategy", "brand foundation", "build my brand strategy", "brand archetype",
  "brand pyramid", "brand essence", "positioning statement", "what does my brand stand
  for", "brand discovery", "brand workshop", "messaging architecture", "message house",
  "brand platform", "brand DNA". Use this whenever someone is starting or rethinking a
  brand and needs the strategy nailed before design begins — even if they just say "help
  me figure out my brand". Foundation skill; writes {brand_context}/brand-strategy.md.
  Does NOT trigger for: written voice/tone execution (use mkt-brand-voice), audience-only
  profiling (use mkt-icp), market sales angles / USP framing (use mkt-positioning), or
  visual identity / colours / fonts / logos (use mkt-visual-identity).
---
