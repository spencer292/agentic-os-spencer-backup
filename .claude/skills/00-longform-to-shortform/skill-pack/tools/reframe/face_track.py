...
def reframe(video_path, output_path):
    ...
    # Derive a 9:16 crop from the ACTUAL source height so the output isn't stretched.
    # The fixed 810x1440 assumed a >=1440-tall source; a 720p Zoom source got cropped
    # to 720 then non-uniformly scaled to 1920 (vertically squashed faces). Crop the
    # full source height and 9/16 of it in width -> uniform scale to 1080x1920.
    crop_h = h
