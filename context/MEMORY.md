...
- **NORTH STAR 1 — Got Moles $5-10M (got-moles-scale):** $857K T12 +37%; 69% close = lead-constrained; $5M≈2,900 members/21 techs/1,100 leads-mo. NOW: LSA (gated: sign-in+COI+consents) + pricing A-F (+$10 ARPU≈$72K/yr). Ninety backfill DONE; await Spencer UI pass (archive dupes, new KPIs) + Monday cron.
