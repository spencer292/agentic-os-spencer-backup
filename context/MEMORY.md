...
- NS1 $5-10M: $857K T12 +37%; close 69%, gap=quote-ISSUE rate. NOW: LSA(gated)+pricing A-F(~$72K/yr). TMCP:437 QF→TMC.
...
- Jobber dupes: 97grp/114 extra, 82% CallRail double-writes (jobber-duplicate-cleanup). GBP 270rev/4.96 ("219+" stale).
