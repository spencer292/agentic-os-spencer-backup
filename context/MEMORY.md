...
## Active Threads
- Routes: **JOBBER=TRUTH day+tech; Optimo only re-sequences** (never grid-tech-realign). Cadence engine LIVE nightly; TMCP ramp miss 50%. PENDING: Aug3-4 catch-up needs --execute; wk Aug10-14 grid rules; 68 out-of-field Spencer visits.
...
- NS2 $100K: kits LIVE Gumroad, $0 rev. Ads+GSC OAuth expired; budget-guard may not fire.
...
- Jobber dupes: 97grp/114 (82% CallRail). GBP 270rev/4.96.
